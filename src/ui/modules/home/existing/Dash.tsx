...
// TODO: automatically calculate the width of panels based on the number of children
export default function Dash({
  ...
  return (
    <Block className="bg-opacity-80">
      ...
      <div className="flex flex-col flex-wrap space-y-4 sm:space-y-0 sm:flex-row justify-around pt-8">
        {children}
      </div>
    </Block>
  );
